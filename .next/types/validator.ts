...
// Validate ../../app/api/products/category/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/products/category">> = Specific
  const handler = {} as typeof import("../../app/api/products/category/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
